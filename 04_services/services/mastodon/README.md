...
> **`LOCAL_DOMAIN` は一度サーバを起動すると変更できない**ため、公開用 URL（[05_relay](../../../../05_relay/README.md) で設定する `mastodon.<ドメイン>`）と必ず一致させる必要があります。
...
> ⚠️ 踏み台/リレーサーバ経由で公開する構成（[05_relay](../../../../05_relay/README.md)）の場合、
